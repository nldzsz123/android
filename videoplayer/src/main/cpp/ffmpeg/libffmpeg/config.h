...
#define FFMPEG_CONFIGURATION "--arch=aarch64 --enable-yasm --enable-gpl --disable-nonfree --enable-shared --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-postproc --enable-avfilter --enable-avresample --disable-hwaccels --enable-hwaccel=h264_videotoolbox --enable-hwaccel=hevc_videotoolbox --disable-encoders --enable-encoder=mjpeg --enable-encoder=png --enable-encoder=h264 --disable-decoders --enable-jni --enable-mediacodec --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=h264_mediacodec --enable-decoder=hevc_mediacodec --disable-muxers --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=hevc --enable-muxer=aac --disable-demuxers --enable-demuxer=aac --enable-demuxer=mp4 --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=aac --disable-parsers --enable-parser=h264 --enable-parser=hevc --enable-protocols --enable-protocol=async --disable-protocol=bluray --disable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --disable-protocol=gopher --disable-protocol='librtmp*' --disable-protocol=libssh --disable-protocol=mmsh --disable-protocol=mmst --disable-protocol='rtmp*' --enable-protocol=rtmp --enable-protocol=rtmpt --enable-protocol=rtp --disable-protocol=sctp --disable-protocol=srtp --disable-protocol=unix --prefix=/Users/developer/ffmpeg/ijkplayer/android/contrib/build/ffmpeg-arm64/output --cross-prefix=aarch64-linux-android- --enable-cross-compile --target-os=android --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG ' --extra-ldflags=' '"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/Users/developer/ffmpeg/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
#define AVCONV_DATADIR "/Users/developer/ffmpeg/ijkplayer/android/contrib/build/ffmpeg-arm64/output/share/ffmpeg"
