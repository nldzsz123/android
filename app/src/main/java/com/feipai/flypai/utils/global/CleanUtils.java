...
public class CleanUtils {
    ...
    /**
     * 清除内部缓存
     * <p>/datas/datas/com.xxx.xxx/cache</p>
     *
    ...
    /**
     * 清除内部文件
     * <p>/datas/datas/com.xxx.xxx/files</p>
     *
     * @return {@code true}: 清除成功<br>{@code false}: 清除失败
     */
    ...
    /**
     * 清除内部数据库
     * <p>/datas/datas/com.xxx.xxx/databases</p>
     *
     * @return {@code true}: 清除成功<br>{@code false}: 清除失败
     */
    ...
    /**
     * 根据名称清除数据库
     * <p>/datas/datas/com.xxx.xxx/databases/dbName</p>
     *
     * @param dbName 数据库名称
     * @return {@code true}: 清除成功<br>{@code false}: 清除失败
     */
    ...
    /**
     * 清除内部SP
     * <p>/datas/datas/com.xxx.xxx/shared_prefs</p>
     *
     * @return {@code true}: 清除成功<br>{@code false}: 清除失败
     */
    ...
    /**
     * 清除外部缓存
     * <p>/storage/emulated/0/android/datas/com.xxx.xxx/cache</p>
     *
     * @return {@code true}: 清除成功<br>{@code false}: 清除失败
     */
