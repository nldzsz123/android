package com.feipai.flypai.utils.shareutils;
...
public class ShareWithSystem {
    ...
    private ShareWithSystem(@NonNull Builder builder) {
    ...
    public static class Builder {
         ...
         * @return Share2
         */
        public ShareWithSystem build() {
            return new ShareWithSystem(this);
        }
