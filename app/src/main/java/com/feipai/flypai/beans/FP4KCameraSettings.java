...
public class FP4KCameraSettings extends FPCameraSettingBase<MultiItemEntity> {
    private String updatevideoDimenssion; // 视频分辨率

    public FP4KCameraSettings() {
    ...
    public ArrayList<MultiItemEntity> photoOptionItems() {
        if (_photoOptionItems == null) {
            ...
            photoAtioItem.commands = ResourceUtils.getStringArray(R.array.PHOTO_SIZE_4K);
...
//        returnItems.add(rawItem);
    ...
    public void updateCameraSettings(SettingBean.ParamBean params) {
        ...
        if (params.getPhoto_size() != null) {
            ...
            String[] values = ResourceUtils.getStringArray(R.array.PHOTO_SIZE_4K);
            int index = 0;
