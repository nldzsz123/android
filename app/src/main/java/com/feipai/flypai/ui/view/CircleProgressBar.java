...
public class CircleProgressBar extends View {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mTextVisibility = a.getInt(R.styleable.CircleProgressBar_progress_text_visibility, VISIBLE);
        ...
        mLineWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_line_width, ConvertUtils.dp2px(DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_size, ConvertUtils.dp2px(DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_stroke_width, ConvertUtils.dp2px(DEFAULT_PROGRESS_STROKE_WIDTH));
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        if (mCenterText != null && !mCenterText.equals("")) {
            progressText = mCenterText;
        }
    ...
    public void setProgressWithCenter(int progress, String centerText) {
        this.mProgress = progress;
