 ...
 */
public class FPButton extends AppCompatButton {
    /**
     * 按钮的背景色
     */
    ...
    public FPButton(Context context) {
        super(context, null);
    }

    public FPButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FPButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a != null) {
            ...
            //设置文字的颜色
            textColor = a.getColorStateList(R.styleable.FPButton_textColor);
            if (textColor != null) {
                setTextColor(textColor);
            }
            //记录按钮被按下时文字的颜色
            textColorPress = a.getColorStateList(R.styleable.FPButton_textColorPress);
            //设置圆角或圆形等样式的背景色
...
//            IAnimationUtils.performAnim(Utils.context, this, R.anim.view_down_scale_anim);
//            if (backColorPress != 0) {
//                if (fillet){
