...
public class KeyBoardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.virtual_keyboard_grid_item, null);
        ...
        if (position == 9) {
            ...
            viewHolder.btnKey.setTextColor(ResourceUtils.getColor(R.color.color_ffffff));
            viewHolder.btnKey.setBackgroundColor(ResourceUtils.getColor(R.color.color_333333));
        } else if (position == 11) {
