...
public class GestureImageViewTouchListener implements OnTouchListener {
    ...
    private boolean isSceenLandScape = false;
    ...
    public GestureImageViewTouchListener(final GestureImageView image, int displayWidth, int displayHeight) {
        ...
        tapDetector = new GestureDetector(image.getContext(), new SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                if (!zoomed) {
                    if (onClickListener != null && !isMoved) {
...
//                                LogUtils.d( "每次滑动都到这里来了----放大情况下");
            ...
            Log.e("TouchView", "onInterceptTouchEvent: " + e);
            return false;
        }
    ...
    protected void handleUp() {
        ...
        if (!canDragX && !canDragY) {
            if (!isSceenLandScape) {
                ...
                lastScale = Math.min(fitScaleHorizontal, fitScaleVertical);
            }
...
//            }
        ...
        LogUtils.d("x-----" + next.x + "||y----" + next.y + "||currentScale=" + currentScale);
    ...
    public void setScreen(boolean isLandScape) {
        this.isSceenLandScape = isLandScape;
    }
    ...
    protected void setFitScaleHorizontal(float fitScale) {
        LogUtils.d("设置缩放比例横向=》fitScaleHorizontal=" + fitScale);
        this.fitScaleHorizontal = fitScale;
    }

    protected void setFitScaleVertical(float fitScaleVertical) {
        LogUtils.d("设置缩放比例纵向=》fitScaleVertical=" + fitScaleVertical);
