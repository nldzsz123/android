...
import com.ardupilotmega.msg_ahrs;
import com.ardupilotmega.msg_ahrs2;
import com.ardupilotmega.msg_airspeed_autocal;
import com.ardupilotmega.msg_ap_adc;
import com.ardupilotmega.msg_battery2;
import com.ardupilotmega.msg_camera_feedback;
import com.ardupilotmega.msg_camera_status;
import com.ardupilotmega.msg_compassmot_status;
import com.ardupilotmega.msg_data16;
import com.ardupilotmega.msg_data32;
import com.ardupilotmega.msg_data64;
import com.ardupilotmega.msg_data96;
import com.ardupilotmega.msg_digicam_configure;
import com.ardupilotmega.msg_digicam_control;
import com.ardupilotmega.msg_fence_fetch_point;
import com.ardupilotmega.msg_fence_point;
import com.ardupilotmega.msg_fence_status;
import com.ardupilotmega.msg_hwstatus;
import com.ardupilotmega.msg_limits_status;
import com.ardupilotmega.msg_mag_cal_report;
import com.ardupilotmega.msg_meminfo;
import com.ardupilotmega.msg_mount_configure;
import com.ardupilotmega.msg_mount_control;
import com.ardupilotmega.msg_mount_status;
import com.ardupilotmega.msg_radio;
import com.ardupilotmega.msg_rally_fetch_point;
import com.ardupilotmega.msg_rally_point;
import com.ardupilotmega.msg_rangefinder;
import com.ardupilotmega.msg_sensor_offsets;
import com.ardupilotmega.msg_set_mag_offsets;
import com.ardupilotmega.msg_simstate;
import com.ardupilotmega.msg_wind;
import com.common.*;
...
public class MAVLinkPacket implements Serializable {
    ...
    public static final int MAVLINK_STX = 254;//254:FE;235:EB;251:FB
    ...
    public void generateCRC() {
        ...
        for (int i = 0; i < payloadSize; i++) {
            crc.update_checksum(payload.getByte() & 0xFF);
        }
...
//        MLog.log("消息id==>" + msgid);
        switch (msgid) {
            ...
            case msg_auth_key.MAVLINK_MSG_ID_AUTH_KEY://加密？
            ...
            case msg_cal_progress_decode.MAG_CAL_PROGRESS:
//                MLog.log("指南针校准进度返回--->");
                return new msg_cal_progress_decode(this);
