...
import com.common.msg_radio_status;
...
public class MAVLinkStats /* implements Serializable */ {
    ...
    public int successPacketCount;//成功通过的packet
...
//        MLog.log("丢包率测试--->直接丢失" + lostPacketCount);
        receivedPacketCount++;
    }
    ...
    public void crcError() {
        crcErrorCount++;
//        MLog.log("丢包率测试--->校验失败" + crcErrorCount);

    }

    public void crcSuccess() {
        successPacketCount++;
//        MLog.log("丢包率测试--->校验通过" + successPacketCount);
    }
